...
import 'package:mol_app/objects/secondary_button_widget.dart';
import 'package:mol_app/pages/sign_up_page.dart';

import '../objects/help_button_widget.dart';
import '../objects/primary_button_widget.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              MolElevatedButton(
                text: Strings.signUp,
                textColor: const Color(0xFFEB6530),
                backgroundColor: const Color(0xFF202020),
                borderColor: const Color(0xFFEB6530),
                onPressedButton: () {
                  Navigator.push(
                    context,
